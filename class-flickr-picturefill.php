...
class Flickr_Picturefill {
	...
	/**
	 * Introduction text to the plugin settings section
	 *
	 * @since    2.1.0
	 */
	public function flickr_options_callback() {
		echo 'Settings related to the Flickr Picturefill plugin';
	}
	...
	public function register_settings() {
		...
		register_setting( $this->plugin_slug . '_setting_group', 'flickr_api_key');
		register_setting( $this->plugin_slug . '_setting_group', 'flickr_user_id');
	...
	public function flickr_api_key_setting() {
		$options = get_option($this->plugin_slug . '_option_group');  echo "<input name='" . $this->plugin_slug . "_option_group[flickr_api_key]' type='text' value='{$options['flickr_api_key']}' />";
	}
	public function flickr_user_id_setting() {
		$options = get_option($this->plugin_slug . '_option_group');  echo "<input name='" . $this->plugin_slug . "_option_group[flickr_user_id]' type='text' value='{$options['flickr_user_id']}' />";
	}
